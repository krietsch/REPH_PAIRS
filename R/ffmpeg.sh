...
#----------------------------------------------------------------
# SETTINGS
input_dir="//ds/grpkempenaers/Hannes/temp/all_reph"  # Replace this by a path to your folder /path/to/your/folder
n_files=6626                         # Replace this by a number of images
