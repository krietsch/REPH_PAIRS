...
sapply( c('data.table', 'anytime', 'foreach', 'auksRuak', 'ggplot2', 'windR', 'sf', 'knitr'),
        require, character.only = TRUE)
...
# rmarkdown::render('./R/0_tag_accuracy_for Sarah.R', output_dir = './OUTPUTS/R_COMPILED')
...
# saveRDS(d, './DATA/test_data_to_share.rds')
...
# 
# saveRDS(dl, './DATA/test_data_waypoints_to_share.rds')

# Data for Sarah
d = readRDS('./DATA/test_data_to_share.rds')
dl = readRDS('./DATA/test_data_waypoints_to_share.rds')
...
# 
# saveRDS(d, './DATA/test_data_male_tag_92_to_share.rds')
# 
# dn[, nestID := paste0(nest, '_', substr(year_, 3,4 ))]
# dn = dn[nestID == 'R203_18']
# 
# saveRDS(dn, './DATA/test_data_nest_R203_18_to_share.rds')

# Data Sarah 
d = readRDS('./DATA/test_data_male_tag_92_to_share.rds')
dn = readRDS('./DATA/test_data_nest_R203_18_to_share.rds')
