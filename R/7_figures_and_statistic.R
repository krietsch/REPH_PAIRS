...
# ggsave('./OUTPUTS/FIGURES/MATE_GUARDING/male_female_together_EPY_polyandry_early_initiation.tiff', plot = last_plot(),  width = 177, height = 177, units = c('mm'), dpi = 'print')
